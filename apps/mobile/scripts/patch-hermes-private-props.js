...
function patchFile(relativeSuffix, replacements) {
  const candidates = [
    path.join(__dirname, '../node_modules', relativeSuffix),
    path.join(__dirname, '../../node_modules', relativeSuffix),
    path.join(process.cwd(), 'node_modules', relativeSuffix),
  ];
...
patchFile(
  'react-native-worklets/src/WorkletsModule/NativeWorklets.native.ts',
  [
...
patchFile(
  'react-native-worklets/lib/module/WorkletsModule/NativeWorklets.native.js',
  [
    [/this\.#workletsModuleProxy/g, 'this._workletsModuleProxy'],
    [/this\.#serializableNull/g, 'this._serializableNull'],
    [/this\.#serializableUndefined/g, 'this._serializableUndefined'],
...
patchFile(
  'react-native-reanimated/src/createAnimatedComponent/NativeEventsManager.ts',
  [
...
patchFile(
  'react-native-reanimated/src/WorkletEventHandler.ts',
  [
...
// 5. JSReanimated.ts
patchFile(
  'react-native-reanimated/src/ReanimatedModule/js-reanimated/JSReanimated.ts',
  [
...
patchFile(
  'react-native-reanimated/src/ReanimatedModule/NativeReanimated.ts',
  [
...
patchFile(
  'react-native-worklets/src/debug/checkCppVersion.ts',
  [
...
patchFile(
  'react-native-worklets/lib/module/debug/checkCppVersion.js',
  [
...
patchFile(
  'react-native-reanimated/src/platform-specific/checkCppVersion.ts',
  [
...
patchFile(
  'react-native-reanimated/lib/module/platform-specific/checkCppVersion.js',
  [
...
patchFile(
  'react-native-reanimated/src/platform-specific/workletsVersion.ts',
  [
...
patchFile(
  'react-native-reanimated/lib/module/platform-specific/workletsVersion.js',
  [
    [/throw new ReanimatedError\(result\.message\);/g, 'console.warn(result.message);']
  ]
);

// 10. Patch react-native-css-interop printUpgradeWarning / stringify crash
patchFile(
...
patchFile(
  'react-native-css-interop/src/runtime/native/render-component.tsx',
  [
...
// 11. Patch NavigationStateContext getters throwing on object traversal
patchFile(
  '@react-navigation/core/lib/module/NavigationStateContext.js',
  [
...
patchFile(
  '@react-navigation/core/src/NavigationStateContext.tsx',
  [
...
patchFile(
  '@react-navigation/core/lib/commonjs/NavigationStateContext.js',
  [
    [/throw new Error\(MISSING_CONTEXT_ERROR\);/g, 'return (() => undefined);']
  ]
);
